...
class DocumentForm(forms.ModelForm):
    class Meta():
        model = Document
        fields = ['title','description','author','key_words','file']
    def __init__(self, *args, **kwargs):
        ...
        self.fields['key_words'] = forms.CharField(widget=forms.TextInput(attrs={'class': 'form-control', 'id': 'key_words'}),max_length=255)
